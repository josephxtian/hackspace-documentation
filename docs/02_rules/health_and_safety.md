...
**If you do not feel competent to use a tool, do not use it.**
 - Find the manual online and read it.
...
* Let others know by filling in the incident report form or posting to the [forum]({{ links.forum }}/c/broken-tools-maintenance-logs/broken-tools/).
...
## Emergency Procedure
Our emergency procedure can be found [here](../04_procedures/emergency_procedure.md).
...
* Refer you to our [disciplinary procedure](./conduct_complaints.md).

## Risk Assesments

All work carried out in Hackspace should be appropriately risk assessed. We maintain risk assessments for all of our tools on our [google drive]({{ links.risk_assessments }}). It is your responsibility to familiarise yourself with the risk assessment for each tool you are using before you use it. If you think the risk assessment is insufficient, or incorrect, we welcome your contribution.
