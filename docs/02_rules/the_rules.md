...
Members are permitted to bring guests with them. Guests must not use induction protected equipment, should be closely supervised and should not disrupt other members. Members are wholly responsible for the actions of their guests. Any member can request someone else's guest or pet leave if they are causing a nuisance.
Under-18s are allowed in the space when accompanied by a member.
