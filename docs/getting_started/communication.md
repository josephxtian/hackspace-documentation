...
The go-to place for keeping up with the goings on in the community. Used for everything from showing off your latest project, to reporting a faulty piece of equipment. Also used for admin announcements, posting events, maintenance updates, scheduling inductions and purchase proposals.

!!! info
    Log in using your membership portal credentials; no need to create a new account.
...
!!! tip
    By the nature of instant messaging, conversations can move fast. Please do not feel like you need to keep up with conversations, all official business will be posted to the forum or emailed.
